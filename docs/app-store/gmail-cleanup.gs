 ...
 *
 * Run it only in powercouple@gmail.com, the account that sends the app's
 * emails: it trashes everything old in the account it runs in.
 *
 * Setup, once: signed in as powercouple@gmail.com, open script.google.com and
 * make a new project. Paste this file over the code there and save. Choose
 * setUp in the function menu and press Run, then allow access when Google
 * asks. Running setUp again is harmless; it replaces the daily trigger.
 */
